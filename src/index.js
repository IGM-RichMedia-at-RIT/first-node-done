...
// call the http module's createServer function with a request callback & listen on port 8000.
// Normally this would be port 80, 443 or 8080, but in this example we use 8000 to prevent
// conflicting with local machine traffic
